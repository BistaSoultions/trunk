...
class product_template(osv.osv):
    ...
    def open_attributes(self, cr, uid, ids, context=None):
        ...
        ir_model_data_id = ir_model_data_obj.search(cr, uid, [['model', '=', 'ir.ui.view'], ['name', '=', 'product_template_attributes_form_view']], context=context)
        if ir_model_data_id:
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        result = super(product_template, self).fields_view_get(cr, uid, view_id,view_type,context,toolbar=toolbar, submenu=submenu)
